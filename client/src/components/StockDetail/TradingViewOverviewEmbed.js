...
const SCRIPT_ID = 'tradingview-overview-widget-script';
const CONTAINER_ID = 'tradingview-overview-widget';

export default class TradingViewOverviewWidget extends PureComponent {
  static propTypes = {
